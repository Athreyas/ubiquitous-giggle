...
**Daykeep** is a private second-brain / bookmark library with **Daymark** daily memory resurfacing.

This codebase is a soft-fork of [Karakeep](https://github.com/karakeep-app/karakeep) (AGPL-3.0).
See `ATTRIBUTION.md` and `LICENSE`. Product branding (Daykeep / Daymark) is independent of Karakeep trademarks.
...
Daykeep (previously Daykeep) is a self-hostable bookmark-everything app with a touch of AI for the data hoarders out there.
...
The name Daykeep is inspired by the Arabic word "كراكيب" (karakeeb), a colloquial term commonly used to refer to miscellaneous clutter, odds and ends, or items that may seem disorganized but often hold personal value or hidden usefulness. It evokes the image of a messy drawer or forgotten box, full of stuff you can't quite throw away—because somehow, it matters (or more likely, because you're a hoarder!).
...
- Bookmark managers (mostly focused on bookmarking links):
    - [Pocket](https://getpocket.com) (Dead): Pocket is what hooked me into the whole idea of read-it-later apps. I used it [a lot](https://blog.mbassem.com/2019/01/27/favorite-articles-2018/). However, I recently got into home-labbing and became obsessed with the idea of running my services in my home server. Daykeep is meant to be a self-hosting first app. Mozilla recently announced that it's shutting down pocket.
...
Daykeep uses Weblate for managing translations. If you want to help translate Daykeep, you can do so [here](https://hosted.weblate.org/engage/hoarder/).

## Daykeep Cloud ☁️

If you're not comfortable with self-hosting, you can use our managed Daykeep cloud at [cloud.karakeep.app](https://cloud.karakeep.app). Cloud subscriptions support the development of Daykeep.

## Support

If you're enjoying using Daykeep, drop a ⭐️ on the repo!
...
Daykeep is licensed under [AGPL-3.0](https://github.com/karakeep-app/karakeep/blob/main/LICENSE) and owned by [Localhost Labs Ltd](https://localhostlabs.co.uk).
