...
Daykeep comes with a simple CLI for those users who want to do more advanced manipulation.
...
```
karakeep --api-key mysupersecretkey --server-addr https://try.daykeep.app whoami
{
...
```json
{
  "serverAddr": "https://try.daykeep.app",
