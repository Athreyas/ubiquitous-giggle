...
Daykeep (previously Daykeep) is an open source "Bookmark Everything" app that uses AI for automatically tagging the content you throw at it. The app is built with self-hosting as a first class citizen.
...
- 🤖 LLM Agents (e.g. OpenClaw, Hermes) friendly with powerful [CLI](https://docs.daykeep.app/integrations/command-line), and [official skills](https://docs.daykeep.app/integrations/agentic-skills).
...
You can access the demo at [https://try.daykeep.app](https://try.daykeep.app). Login with the following creds:

```
email: demo@daykeep.app
password: demodemo
```
