...
Daykeep uses `node` version 22. To install it, you can use `nvm` [^1]
...
Daykeep also makes use of `corepack`[^2]. If you have `node` installed, then `corepack` should already be
