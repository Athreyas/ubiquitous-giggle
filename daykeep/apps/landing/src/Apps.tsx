...
const communityProjects: Listing[] = [
  {
    ...
    description: "Manage your Daykeep bookmarks directly from Raycast.",
    url: "https://www.raycast.com/luolei/karakeep",
    badge: raycastIcon,
  },
  {
    name: "Obsidian Plugin",
    description: "Sync your Daykeep bookmarks to Obsidian as markdown notes.",
...
const agenticSkills: Listing[] = [
  {
    name: "ClawHub",
    description: "Install the Daykeep skill for agentic assistants.",
    ...
    <div className="container mx-auto pb-16">
      <main className="px-4 py-8 sm:px-6 sm:py-14">
        ...
        <p className="mt-3 max-w-2xl text-base text-gray-600 sm:text-lg">
          Use Daykeep anywhere with our mobile apps and browser extensions.
        </p>
        <div className="mt-10 space-y-6">
          ...
          <ListingSection
            ...
            description="Integrations built by the Daykeep community."
            items={communityProjects}
          />
          <ListingSection
            title="Agentic Skills"
            description="Connect AI assistants to Daykeep with installable skills."
            items={agenticSkills}
          />
        </div>
      </main>
