    ...
    <div className="mx-auto max-w-3xl p-4">
      <main className="space-y-6">
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          Daykeep Cloud (&ldquo;Service&rdquo;), operated by Localhost Labs Ltd
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          Daykeep Cloud (including search and tagging features), and you need
        ...
        <p className="text-base leading-relaxed text-gray-700">
          Daykeep Cloud is a hosted bookmarking and content-saving service that
          ...
          version of Daykeep. Self-hosted instances of Daykeep are governed by
        ...
        <p className="text-base leading-relaxed text-gray-700">
          Access to the Daykeep API is governed by these Terms. We may impose
        ...
        <p className="text-base leading-relaxed text-gray-700">
          The Daykeep name, logo, and service features are the property of
          Localhost Labs Ltd. The open-source code that powers Daykeep is
