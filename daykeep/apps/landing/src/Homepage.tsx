...
const featuresList = [
  ...
  },
  {
    icon: SunMoon,
    title: "Dark Mode",
    description: "Daykeep supports dark mode for better reading experience.",
  },
];
...
const _showcases = [
  {
    ...
    description:
      "Save links, notes, images, and PDFs from any device. Daykeep automatically fetches titles, descriptions, and images so you never lose context.",
    bullets: [
    ...
    screenshotAlt: "Daykeep tags view",
    reverse: false,
  },
  {
    label: "ORGANIZATION",
    ...
    description:
      "Daykeep uses AI to automatically tag and categorize your bookmarks. Stop spending time filing things away — just save and let AI do the work.",
    bullets: [
    ...
    screenshotAlt: "Daykeep search view",
    reverse: true,
  },
  {
    label: "READING",
    ...
    screenshotAlt: "Daykeep reader view",
    reverse: false,
  },
  {
    label: "AUTOMATION",
    ...
    screenshotAlt: "Daykeep rule engine",
    reverse: true,
  },
];
