    ...
    <div className="mx-auto max-w-3xl p-4">
      <main className="space-y-6">
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          share it for Daykeep Cloud. Localhost Labs Ltd is the data controller
          for personal data processed under this policy. Daykeep Cloud is
        ...
        <p className="text-base leading-relaxed text-gray-700">
          We use your data to run and improve Daykeep Cloud, including to:
        </p>
        <ul className="ml-6 list-disc space-y-2 text-gray-700">
        ...
        <p className="text-base leading-relaxed text-gray-700">
          We use subprocessors to run Daykeep Cloud. They only process data on
        ...
        <p className="text-base leading-relaxed text-gray-700">
          Daykeep Cloud stores primary data in Europe. Some subprocessors may
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          or support@daykeep.app. We respond within timelines required by
          applicable law.
        </p>

        <h2 className="text-lg font-semibold text-gray-900">11. Children</h2>
        <p className="text-base leading-relaxed text-gray-700">
          Daykeep Cloud is not intended for children under 16. If you believe a
        ...
        <p className="text-base leading-relaxed text-gray-700">
          The Daykeep browser extension works with your Daykeep account. It
          ...
          only to Daykeep Cloud and is not shared with third parties. Content
        ...
        <p className="text-base leading-relaxed text-gray-700">
          This policy applies to Daykeep Cloud. If you self-host Daykeep, your
        ...
        <p className="text-base leading-relaxed text-gray-700">
          ...
          Support:{" "}
          <a
            href="mailto:support@daykeep.app"
            className="text-blue-600 hover:underline"
          >
            support@daykeep.app
          </a>
