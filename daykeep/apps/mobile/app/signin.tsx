...
const DEFAULT_SERVER_ADDRESS = "https://cloud.daykeep.app";
const CONNECTION_ERROR_MESSAGE =
  "Couldn’t connect to this Daykeep server. Check the server address and your internet connection, then try again.";
